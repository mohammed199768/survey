...
export function TopicCard({ dimensionId: _dimensionId, topic }: { dimensionId: string; topic: TopicStructure }) {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className="px-4 sm:px-5 lg:px-8 pt-4 lg:pt-5 pb-3 lg:pb-4 bg-white shrink-0">
      ...
      {/* Prompt Strip */}
      <div className="px-4 sm:px-5 lg:px-8 py-2.5 lg:py-3 bg-[#f6f7f9] shrink-0">
      ...
      {/* Body */}
      <div className="px-4 sm:px-5 lg:px-8 pt-2 pb-6 lg:pb-8 bg-[#f6f7f9] flex-1 flex flex-col justify-start">
