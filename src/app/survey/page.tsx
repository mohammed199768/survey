  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] font-sans">
      ...
      <main className="pt-24 pb-12 px-6 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-[32rem] h-[32rem] bg-gradient-to-br from-blue-100/70 to-slate-100/20 rounded-full blur-3xl -translate-x-1/3 -translate-y-1/3" />
        <div className="absolute bottom-0 right-0 w-[30rem] h-[30rem] bg-gradient-to-tl from-slate-200/50 to-blue-100/30 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="rounded-3xl border border-white/80 bg-white/90 shadow-[0_12px_40px_rgba(15,23,42,0.08)] backdrop-blur p-8 md:p-10 relative">
            ...
            <div className="text-center mb-8 md:mb-10">
              <span className="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-[11px] tracking-[0.18em] font-semibold text-blue-800 uppercase">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-900 placeholder:text-slate-400"
              ...
              <div className="flex items-start gap-3 pt-1 rounded-xl border border-slate-200 bg-slate-50/60 p-4">
                <input
                  type="checkbox"
                  id="consent"
                  className="mt-0.5 w-5 h-5 text-blue-600 rounded focus:ring-blue-500 border-slate-300"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-800 text-white rounded-xl font-semibold text-lg hover:brightness-110 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_8px_24px_rgba(15,23,42,0.25)]"
              >
